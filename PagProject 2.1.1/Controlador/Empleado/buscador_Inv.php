...
<table class="table table-bordered" style="max-width: 70%; margin: auto;"> 
        ...
        <tr>
<tr>
<th colspan="8"><a href="../../Vista/Empleado/inicio_empleado.php" style="color: white"><button class="btn btn-info">Volver a la pagina principal</button></a></th><form action="../../Vista/PDF/buscador_inv_rep.php" method="POST">
