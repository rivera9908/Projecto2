...
<html>
	<head>
		...
		<style type="text/css">
		body{
			background: "../../Vista/Administrador/img/fondo.jpg";
		}
	...
	<body background="../../Vista/Administrador/img/fondo.jpg">
		<center>
		<?php
					...
					<div class="table-responsive">
						<table class="table table-bordered" id="dynamic_field">
							...
							<tr>
                                ...
                                <td><input type="number" name="cantidad[]" value="1" min="1" max="80" class="form-control name_list"></td>
                                <td>
						...
						<tr>
<a href="../../Vista/Empleado/ver_inventario.php"><input type="button" value="Ver Inventario" id="boton" style="color:white">
<a href="../../Vista/Empleado/inicio_empleado.php"><input type="button" value="Volver" id="boton" style="color:white">
</tr>
					</div><br>
...
$(document).ready(function(){
	...
	$('#add').click(function(){
		...
		$('#dynamic_field').append('<tr id="row'+i+'"><td></td><td><select class="form-control" name="ingred[]" ><?php
                                    ...
                                    ?></select></td><td><input type="number" name="cantidad[]" value="1" min="1" max="80" class="form-control name_list"></td><td><button type="button" name="remove" id="'+i+'" class="btn btn-danger btn_remove">X</button></td></tr>');
	});
