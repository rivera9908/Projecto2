...
<th colspan="2"><a href="../../Vista/Administrador/inicio_administrador.php" style="color:white"><button class="btn btn-info">Volver a la pagina principal</button></a></th> <form action="../../Vista/PDF/buscador_com_rep_nom.php" method="POST">
              <input type="text" name="nombre" value="<?php echo $nombre_ing; ?>" style="display: none" placeholder="ej: 15/08/2018">
