...
<tr>
<th colspan="8"><a href="../../Vista/Administrador/inicio_administrador.php" style="color: white"><button class="btn btn-info">Volver a la pagina principal</button></a></th><form action="../../Vista/PDF/buscador_inv_rep_nom.php" method="POST">
...
while($usuario = mysqli_fetch_array($resultado)){ ?> 
    <tr> 
        ...
        <th colspan=""><a href="../../Controlador/Administrador/eliminar_est_inv.php?cod_auditoria=<?php echo $usuario ['cod_auditoria'];?>" style="color:white"><button class="btn btn-success">Eliminar</button></a></th> 
