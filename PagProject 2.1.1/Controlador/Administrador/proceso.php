...
if(isset($_POST['registrar'])){
   ...
   header("location:./registrousu.php?dato1");
	...
	('$Id_usu', '$Nom_usu','$Pass_usu','$Tipo_doc_Tipo_doc' ,'$Rol_nom_rol',1,'$Tipo_telefono','$Num_tel','$Correo')";
 ...
 if ($result==true){
	...
	print "<script>alert(\"Registro correcto\");window.location='../../Vista/Administrador/mostrarusu.php';</script>";
 }else{

 	print "<script>alert(\"Error al registrar\");window.location='../../Vista/Administrador/mostrarusu.php';</script>";
 }
