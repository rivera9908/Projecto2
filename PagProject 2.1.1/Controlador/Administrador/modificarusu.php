...
<body >
<center>
<h1 style=#fff><b>Modificar Usuarios</b></h1>
</center>
<?php
require("../../Modelo/conexion.php");
...
<form action="proceso_modificarusu.php?Id_usu<?php echo $row['Id_usu'];?>" method="post" enctype="multipart/form-data" style="margin: auto; max-width: 55%;">
<form>
<table class="table table-bordered" id="dynamic_field">
<tr><td>Tipo // Documento </td>
<td><select name="Tipo_doc_Tipo_doc" value="<?php echo $row['Tipo_doc_Tipo_doc'];?>" placeholder="introduzca el codigo">
...
<tr><td> Correo</td><td>
<input class="form-control name_list" type="text" name="Correo"  value="<?php echo $row['Correo'];?>" placeholder="Correo Electronico" required></td></tr>
</table>
