...
<body>
<center>
<h1>Resultado de Busqueda Inventario por Fecha</h1></br>
...
se muestra informacion especifica correspondiente a la fecha digitada, de tal manera que solo se visualizara informacion de de los ingredientes ingresados e utilizados por la fruteria. Ademas se muestra la cantidad de ingredientes que quedan actualmente del ingrediente utilizado o ingresado.</p></center></font>
...
$dompdf->render();
$dompdf->stream("Reporte de Busqueda de Inventario.pdf");
?>
