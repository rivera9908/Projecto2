...
<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
    <table class="table">
        ...
        <tr style="display: none">
            <td colspan="2"><label>
                    <input type="text" name="nombre" value="<?php if(isset($_POST["envianame"])){echo $nombre;} ?>">
                </label></td>
        </tr>
        <tr>
            <td colspan="2"><label for="text"></label><input type="text" name="id" id="text" required></td>
        </tr>

        <tr>
            <td>Digita la fecha en la estas haciendo esta compra</td>
        </tr>
        <tr>
...
<form action="carritocompras.php" method="post">
    <table class="table" id="tDos">
        <tr>
            <td colspan="2"><label>
                    <input type="text" name="nom" value="<?php if(isset($_POST["envianame"])){echo $nombre;} ?>" style="display: none">
                </label></td>
        </tr>
        <tr>
            <td colspan="2"><label>
                    <input type="text" name="code" value="<?php if(isset($_POST["envianame"])){echo $nombre;} ?>" style="display: none">
                </label></td>
        </tr>
        <tr>
