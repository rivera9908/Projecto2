...
<tr>
<th colspan="8"><a href="inicio_administrador.php" style="color: white"><button class="btn btn-info">Volver a la pagina principal</button></a> <a href="../PDF/reporte_inventario.php" style="color:white"><button class="btn btn-danger">Generar reporte</button></a></th>
...
while($usuario = mysqli_fetch_array($resultado)){ ?> 
    <tr> 
        ...
        <th><a href="../../Controlador/Administrador/eliminar_est_inv.php?cod_auditoria=<?php echo $usuario ['cod_auditoria'];?>" style="color:white"><button class="btn btn-success">Eliminar</button></a></th> 
