...
<body>
	...
	<table class="table table-bordered" style="max-width: 70%; margin: auto;">
	  <thead>
	  	...
	  	<tr>
        <th colspan="12"><button class="btn btn-info"><a href="../../Controlador/Administrador/ad_producto.php" style="color:white">Nuevo Producto</a></button>
        	<button class="btn btn-info"><a href="inicio_administrador.php" style="color:white">Volver al inicio</a></button></th>
