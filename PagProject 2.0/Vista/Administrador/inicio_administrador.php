      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
              <a href="../../Controlador/Administrador/ver_ing.php" class="nav-link" style="color: white;"><b>Ingresar Ingredientes</b></a>
            </li>
            <li class="nav-item">
              <a href="../PDF/vercompras.php" class="nav-link" style="color: white;"><b>Reportes Compras</b></a>
              </li>
