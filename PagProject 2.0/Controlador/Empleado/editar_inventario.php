...
<body background="../../Vista/Empleado/img/cerezas.jpg">
	<?php
		...
		if (isset($_REQUEST['eliminar_ing'])){
			...
			$sqle = "DELETE FROM inventario WHERE Ingredientes_cod_ingrediente = $Ingredientes_cod_ingrediente";
						...
						<table class="table table-bordered" id="dynamic_field">
							...
							<tr class="success">
								...
								<td><button type="button" name="add" id="add" class="btn btn-success">Añadir Ingrediente</button></td>
                                    ...
                                    <?php 
                                    $sql22 = "SELECT t1.cod_ingrediente, t1.Nom_ing  from ingredientes as t1 JOIN producto_has_ingredientes as t2 on (t1.cod_ingrediente = t2.Ingredientes_cod_ingrediente) WHERE t2.PRODUCTO_cod_producto = $n_inventario";
