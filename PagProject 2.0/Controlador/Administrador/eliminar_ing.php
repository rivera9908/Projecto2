...
if (isset($_REQUEST['eliminar'])){
			...
			$sqle = "DELETE FROM Ingredientes WHERE cod_ingrediente = $cod_ingrediente";
			$resultado= mysqli_query($con, $sqle);
			

			if ($resultado==true){

			print "<script>alert('Ingrediente eliminado exitosamente.');window.location='ver_ing.php';</script>";
			}else{
