...
<tr><td>Correo</td><td>
<input class="form-control name_list" type="text" name="Correo"  placeholder="Correo Electronico" required></td></tr>
</table>
<input type="submit" name="registrar" class="btn btn-success" style="color:white" value="Registrar"><button class="btn btn-danger">
<a href="../../Vista/Administrador/mostrarusu.php" style="color: white">Cancelar</a></button>
