      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
              <a href="imagenes mostrar/index.html" class="nav-link">ingresar productos</a>
            </li>
            <li class="nav-item">
              <a href="../ingrediente.php" class="nav-link">ingresar ingredientes </a>
            </li>
            <li class="nav-item">
              <a href="../Listaringredientes.php" class="nav-link">inventario</a>
              </li>
              <li class="nav-item">
              <a href="veropiniones.php" class="nav-link">comentarios</a>
              </li>
        </div>
      </div>
    </nav>
              ...
              <div class="col-lg-8 d-none d-sm-block">
                ...
                <div class="d-flex flex-row">
                  ...
                  <div class="p-4 align-self-end">
                    revisar opiniones y calificaciones de los productos 
                  </div>
                </div>
                <!-- check -->
                <div class="d-flex flex-row">
                  ...
                  <div class="p-4 align-self-end">
                   añadir nuevos productos o ingredientes ademas de revisar el inventario
                  </div>
                </div>
                <!-- check -->
                <div class="d-flex flex-row">
                  ...
                  <div class="p-4 align-self-end">
                  revisar informes hechos por el empleado
                   </div>
                </div>
        ...
        <div class="row">
          <div class="col text-center">
            <div class="p-5">
              ...
              <p class="lead"></p>
              <a href="mostrarusu.php" class="btn btn-outline-secondary">ver</a>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="row">
          <div class="col text-center">
            <div class="p-5">
              ...
              <p class="lead"></p>
              <a href="../Listaringredientes.php" class="btn btn-outline-secondary text-white">inventario</a>
            </div>
          </div>
        </div>
      </div>
